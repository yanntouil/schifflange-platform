    ...
    <div className='space-y-4'>
      ...
      <Ui.Collapsible.Root className='space-y-4' open={displayLink}>
        ...
        <Ui.Collapsible.Content className='overflow-hidden data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down'>
          <Cms.Links.FormSingle pathNames={["props", "cards", id, "link"]} asLink noText />
...
const dictionary = {
  fr: {
    ...
    "template-1": "Petite carte avec image et fond",
    "template-2": "Petite carte avec image",
  },
  en: {
    cards: {
      "header-title": "Cards",
    ...
    "template-1": "Small card with image and background",
    "template-2": "Small card with image",
  },
  de: {
    cards: {
      "header-title": "Karten",
    ...
    "template-1": "Kleine Karte mit Bild und Hintergrund",
    "template-2": "Kleine Karte mit Bild",
  },
}
