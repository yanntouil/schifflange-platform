...
const dictionary = {
  fr: {
    ...
    "template-1": "Image à droite",
    "template-2": "Image à gauche",
    "template-3": "Image fixe",
    "template-4": "Pleine largeur",
  },
  en: {
    cards: {
      "header-title": "Cards",
    ...
    "template-1": "Image on the right",
    "template-2": "Image on the left",
    "template-3": "Fixed image",
  ...
  de: {
    ...
    "template-1": "Bild rechts",
    "template-2": "Bild links",
    "template-3": "Festes Bild",
    "template-4": "Volle Breite",
  },
}
