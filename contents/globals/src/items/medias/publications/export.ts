...
export const contentItem = {
  type: "medias-publications" as const,
  props: {
    level: "1",
    displayHeading: true,
    orderedPublications: [] as string[],
    publications: {} as Record<string, PublicationProps>,
    limit: 6,
  ...
  translations: {
    fr: {
      ...
      publications: {} as Record<string, PublicationTranslationsProps>,
  ...
  proses: {
    ...
    publicationDescription: proseVariants({ variant: "default" }),
  },
...
type PublicationTranslationsProps = {
  title: string
  description: string
}
