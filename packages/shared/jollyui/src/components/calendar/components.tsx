 ...
 * CalendarHeading
 */
export const CalendarHeading: React.FC<React.HTMLAttributes<HTMLElement>> = (props) => {
 ...
 * CalendarGrid
 */
export const CalendarGrid: React.FC<AriaCalendarGridProps> = ({ className, ...props }) => (
 ...
 * CalendarGridHeader
 */
export const CalendarGridHeader: React.FC<AriaCalendarGridHeaderProps> = ({ ...props }) => (
 ...
 * CalendarHeaderCell
 */
export const CalendarHeaderCell: React.FC<AriaCalendarHeaderCellProps> = ({ className, ...props }) => (
 ...
 * CalendarGridBody
 */
export const CalendarGridBody: React.FC<AriaCalendarGridBodyProps> = ({ className, ...props }) => (
 ...
 * CalendarCell
 */
export const CalendarCell: React.FC<AriaCalendarCellProps> = ({ className, ...props }) => {
 ...
 * JollyCalendar
 */
export interface JollyCalendarProps<T extends AriaDateValue> extends AriaCalendarProps<T> {
  errorMessage?: string
}

const JollyCalendar = <T extends AriaDateValue>({
  errorMessage,
  className,
  ...props
}: JollyCalendarProps<T>): React.ReactElement => {
  return (
 ...
 * JollyRangeCalendar
 */
export interface JollyRangeCalendarProps<T extends AriaDateValue> extends AriaRangeCalendarProps<T> {
  errorMessage?: string
}

const JollyRangeCalendar = <T extends AriaDateValue>({
  errorMessage,
  className,
  ...props
}: JollyRangeCalendarProps<T>): React.ReactElement => {
  return (
...
export { JollyCalendar, JollyRangeCalendar }
