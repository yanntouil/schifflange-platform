...
const PanelLeftOpen = forwardRef<PanelLeftOpenIconHandle, PanelLeftOpenIconProps>(
    ...
    return (
      <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
        ...
        >
          ...
          <path d='M9 3v18' />
          <motion.path transition={defaultTransition} variants={pathVariants} animate={controls} d='m14 9 3 3-3 3' />
        </svg>
      </div>
    )
  }
