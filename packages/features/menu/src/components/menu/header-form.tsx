...
export const HeaderForm: React.FC = () => {
  ...
  return (
    <FormTranslatableTabs classNames={{ root: "space-y-6" }}>
      ...
      {!isGroup && (
        <>
          <Form.Header title={_("render-title")} description={_("render-description")} />
          <div className='rounded-md border border-input p-6'>
            {templates.length > 0 && (
              <Form.Fields name={"props"}>
                <Form.Template
                  name='template'
            ...
            <Form.Fields name={"props"}>
              <FormMedia.Image
                ...
                ratio='aspect-square'
                classNames={{ input: "w-32", item: "pt-6" }}
              />
            </Form.Fields>
          </div>
        </>
...
const dictionary = {
  fr: {
    ...
    "template-1": "Simple",
    "template-2": "Image de fond",
    "template-3": "Appel à l'action",
  },
  de: {
    ...
    "template-1": "Einfach",
    "template-2": "Hintergrundbild",
    "template-3": "Handlungsaufforderung",
  },
  en: {
