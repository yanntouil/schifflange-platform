 ...
 */
export const useCreateCategory = (mutate?: (category: Api.EventCategory) => void) => {
  const [createCategory, createCategoryProps] = Ui.useQuickDialog<void, Api.EventCategory>({
    mutate: async (category) => void mutate?.(category),
  })
...
export const useEditCategory = (swr: SWRCategories) => {
  const [editCategory, editCategoryProps] = Ui.useQuickDialog<Api.EventCategory>({
...
export const useConfirmDeleteCategory = (swr: SWRCategories) => {
  ...
  const [confirmDeleteCategory, confirmDeleteCategoryProps] = Ui.useConfirm<Api.EventCategory>({
 ...
 */
export const useConfirmDeleteSelectionCategory = (swr: SWRCategories, selectable: Selectable<Api.EventCategory>) => {
  const { _ } = useTranslation(dictionary)
  const { service } = useEventsService()
 ...
 * useManageCategory
 */
export const useManageCategory = (swr: SWRCategories, selectable: Selectable<Api.EventCategory>) => {
