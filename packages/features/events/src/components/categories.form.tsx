...
const dictionary = {
  fr: {
    ...
    "title-info":
      "Le titre de la catégorie qui sera affiché dans l'interface et utilisé pour organiser les événements.",
    "description-label": "Description",
    "description-placeholder": "Entrez une courte description de la catégorie",
    "description-info": "La description aide à comprendre le type d'événements que cette catégorie contient.",
  },
  en: {
    "image-label": "Image",
    ...
    "title-info": "The category title that will be displayed in the interface and used to organize events.",
    "description-label": "Description",
    "description-placeholder": "Enter a short description of the category",
    "description-info": "The description helps understand the type of events this category contains.",
  },
  de: {
    "image-label": "Bild",
    ...
    "title-info":
      "Der Kategorietitel, der in der Benutzeroberfläche angezeigt und zur Organisation von Veranstaltungen verwendet wird.",
    "description-label": "Beschreibung",
    "description-placeholder": "Geben Sie eine kurze Beschreibung der Kategorie ein",
    "description-info": "Die Beschreibung hilft zu verstehen, welche Art von Veranstaltungen diese Kategorie enthält.",
  },
}
