...
export const useCreateCategory = (swr: SWRCategories) => {
  const [createCategory, createCategoryProps] = Ui.useQuickDialog<void, Api.ProjectCategory>({
...
export const useEditCategory = (swr: SWRCategories) => {
  const [editCategory, editCategoryProps] = Ui.useQuickDialog<Api.ProjectCategory>({
...
export const useConfirmDeleteCategory = (swr: SWRCategories) => {
  ...
  const [confirmDeleteCategory, confirmDeleteCategoryProps] = Ui.useConfirm<Api.ProjectCategory>({
 ...
 */
export const useConfirmDeleteSelectionCategory = (swr: SWRCategories, selectable: Selectable<Api.ProjectCategory>) => {
  const { _ } = useTranslation(dictionary)
  const { service } = useProjectsService()
 ...
 * useManageCategory
 */
export const useManageCategory = (swr: SWRCategories, selectable: Selectable<Api.ProjectCategory>) => {
