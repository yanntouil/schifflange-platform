...
export const Categories: React.FC = () => {
  ...
  const [pagination, paginate] = Ui.usePagination<Api.ProjectCategory>(results, 1, 25)
  const paginatedCategories = paginate(filtered) as Api.ProjectCategory[]
  return (
    <>
...
const dictionary = {
  ...
  de: {
    ...
    empty: {
      ...
      "no-item-content-create": "Beginnen Sie mit der Erstellung Ihrer ersten Kategorie {{create:hier klicken}}",
      "no-item-content": "Es gibt hier momentan keine Kategorien.",
