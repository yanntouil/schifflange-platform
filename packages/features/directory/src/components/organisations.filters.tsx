...
import { useFiltersOrganisations } from "../hooks/use-filters-organisations"

/**
 * OrganisationsFilters
 */
export const OrganisationsFilters: React.FC<ReturnType<typeof useFiltersOrganisations>[0]> = (props) => {
...
const dictionary = {
  en: {
    "tooltip-all": "Filter organisations by type",
    tooltip: "Filter organisations by type: {{selectedType}}",
  ...
  fr: {
    "tooltip-all": "Filtrer les organisations par type",
    tooltip: "Filtrer les organisations par type: {{selectedType}}",
    "type-label": "Type: {{selectedType}}",
  ...
  de: {
    "tooltip-all": "Organisationen filtern nach Typ",
    tooltip: "Organisationen filtern nach Typ: {{selectedType}}",
