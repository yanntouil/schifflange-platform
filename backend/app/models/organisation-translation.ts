 ...
 * preloaders
 */
export const preloadOrganisationTranslation = (query: PreloaderContract<OrganisationTranslation>) =>
  query
export const withOrganisationTranslations = () =>
  ['translations', preloadOrganisationTranslation] as const
