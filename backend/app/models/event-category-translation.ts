...
/**
 * Model for Event Category Translation (CMS)
 * event category translation is a translation part of a event category
 */
type Model = EventCategoryTranslation
export default class EventCategoryTranslation extends ExtendedModel {
  public static table = 'event_category_translations'
 ...
 * preloaders
 */
export const preloadEventCategoryTranslation = (
  query: PreloaderContract<EventCategoryTranslation>
) => query.preload(...withImage())
export const withEventCategoryTranslations = () =>
  ['translations', preloadEventCategoryTranslation] as const
