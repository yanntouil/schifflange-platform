...
const dictionary = {
  ...
  fr: {
    ...
    "address-placeholder": "Entrez votre adresse",
  ...
  de: {
    ...
    "profession-description": "Teilen Sie uns mit, wo Sie arbeiten und was Sie tun.",
    ...
    "contact-description": "Fügen Sie Möglichkeiten hinzu, wie andere Sie kontaktieren können.",
    ...
    phones: {
      ...
      "button-delete": "Telefonnummer löschen",
    },
    "extras-label": "Zusätzliche Felder",
    extras: {
      "name-placeholder": "Feldname",
      "name-default": "",
      "value-placeholder": "Feldinhalt",
      "value-default": "",
      "button-add": "Zusätzliches Feld hinzufügen",
      "button-delete": "Zusätzliches Feld löschen",
    },
    "address-title": "Adresse",
