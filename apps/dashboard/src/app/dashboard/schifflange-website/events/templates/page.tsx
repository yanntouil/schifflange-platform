...
const dictionary = {
  en: {
    title: "Templates",
    description: "Create and manage reusable content templates for your events",
    create: "Create a new template",
  },
  fr: {
    title: "Modèles",
    description: "Créez et gérez des modèles de contenu réutilisables pour vos événements",
    create: "Créer un nouveau modèle",
  },
  de: {
    title: "Vorlagen",
    description: "Erstellen und verwalten Sie wiederverwendbare Inhaltsvorlagen für Ihre Veranstaltungen",
