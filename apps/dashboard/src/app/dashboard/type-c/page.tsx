...
const dictionary = {
  en: {
    title: "Type C Workspace",
    description: "Manage your Type C workspace content",
    "pages-title": "Pages",
  ...
  fr: {
    title: "Espace Type C",
    description: "Gérez le contenu de votre espace Type C",
    "pages-title": "Pages",
  ...
  de: {
    title: "Arbeitsbereich Typ C",
    description: "Verwalten Sie die Inhalte Ihres Typ C-Arbeitsbereichs",
    "pages-title": "Seiten",
