...
import { LayoutPanelTop, Newspaper, Presentation, TrendingUp } from "lucide-react"
import React from "react"
import { Link } from "wouter"
import routeToArticle from "./articles/[articleId]"
import routeToPage from "./pages/[pageId]"
import routeToProject from "./projects/[projectId]"
            ...
            topContent.map((item) => (
              <Link
                ...
                href={match(item.type)
                  ...
                  .with("project", () => routeToProject(item.id))
                  .exhaustive()}
              >
                <div className="flex items-center gap-2 overflow-hidden">
                  {match(item.type)
                    ...
                    .with("project", () => <Presentation className="size-3 shrink-0 text-purple-500" />)
                    .exhaustive()}
