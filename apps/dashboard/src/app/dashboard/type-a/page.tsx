...
const dictionary = {
  en: {
    title: "Type A Workspace",
    description: "Manage your Type A workspace content",
    "pages-title": "Pages",
  ...
  fr: {
    title: "Espace Type A",
    description: "Gérez le contenu de votre espace Type A",
    "pages-title": "Pages",
  ...
  de: {
    title: "Arbeitsbereich Typ A",
    description: "Verwalten Sie die Inhalte Ihres Typ A-Arbeitsbereichs",
    "pages-title": "Seiten",
