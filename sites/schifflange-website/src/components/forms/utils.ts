 ...
 */
export const formatDateToFormInput = (date: unknown) =>
  T.isDate(date) ? T.format(date, 'yyyy-LL-dd') : ''
 ...
 */
export const formatDatetimeToFormInput = (date: unknown) =>
  T.isDate(date) ? T.format(date, "yyyy-MM-dd'T'HH:mm") : ''
