...
const DropdownMenuRoot: React.FC<DropdownMenuRootProps> = ({ children, ...props }) => {
  return (
    <DropdownMenuPrimitive.Root {...props} data-slot='dropdown-menu-root'>
      {children}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Trigger ref={ref} className={className} data-slot='dropdown-menu-trigger' {...props} />
))
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioGroup ref={ref} className={className} data-slot='dropdown-menu-radio-group' {...props} />
))
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cxm("-mx-1 my-1 h-px bg-border/60", className)}
...
const DropdownMenuShortcut = React.forwardRef<React.ElementRef<"span">, DropdownMenuShortcutProps>(
  ({ className, mac, windows, children, ...props }, ref) => {
    ...
    return (
      <span
        ref={ref}
        className={cxm("ml-auto text-xs tracking-widest text-muted-foreground", className)}
