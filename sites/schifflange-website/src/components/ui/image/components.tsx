...
export const MediaImage = (props: React.ComponentProps<"img"> & { image: MediaImageProps | null | undefined }) => {
...
export const ImagePlaceholder = (props: React.ComponentProps<"div"> & { placeholder?: boolean }) => {
  const { children, placeholder, ...divProps } = props
  const { _ } = useTranslation(dictionary)

  return (
    <div {...divProps} className={cx("overflow-hidden [&_img]:object-cover [&_img]:size-full", divProps.className)}>
      {children}
