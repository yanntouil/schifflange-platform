 ...
 * Component
 */
const PdfSlide: React.FC<{ slide: SlidePdf }> = ({ slide }) => {
  const containerRef = React.useRef<HTMLDivElement>(null)
  const containerSize = useContainerSize(containerRef as React.RefObject<HTMLElement>)
  ...
  return (
    <div className='size-full max-h-full max-w-full' ref={containerRef}>
      <Lightbox.Transform.Root className='group/transform-content relative flex items-center justify-center'>
        <PdfSlideContent slide={slide} containerSize={containerSize} />
