      ...
      <Primitives.Dialog.Portal>
        ...
        >
          <div className='flex flex-col gap-1 border-b border-[#E5D2B9] p-4'>
            <Primitives.Dialog.Title className='text-base font-medium'>{_("consent.title")}</Primitives.Dialog.Title>
          ...
          <div className='flex flex-wrap justify-center gap-4 border-b border-[#E5D2B9] px-4 py-2 sm:justify-between'>
            <div className='flex flex-wrap justify-center gap-4'>
              <Ui.Button variant='outline' onClick={acceptAll}>
                {_("consent.accept-all")}
              </Ui.Button>
              <Ui.Button variant='outline' onClick={rejectAll}>
                {_("consent.reject-all")}
              </Ui.Button>
            </div>
            <Ui.Button onClick={() => setPreferences(true)}>{_("consent.manage-cookies")}</Ui.Button>
          </div>
