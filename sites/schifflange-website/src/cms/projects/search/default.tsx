          ...
          <div className='space-y-2'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-2'>
              ...
              <CategoriesFilter
                ...
                onCategoriesChange={(newCategories) => setSearchState({ categories: newCategories, page: "1" })}
              />
                            ...
                            <PaginationItem>
                              <PaginationPrevious
                                ...
                                onClick={(e) => {
                                  e.preventDefault()
                                  setSearchState({
                                    page: String(Math.max(1, projectsData.metadata.currentPage - 1)),
                                  })
                                }}
                                aria-disabled={projectsData.metadata.currentPage === 1}
                                className={
                                  projectsData.metadata.currentPage === 1 ? "pointer-events-none opacity-50" : ""
                                }
                              />
                            </PaginationItem>

                            {Array.from({ length: projectsData.metadata.lastPage }, (_, i) => i + 1).map((pageNum) => (
                            ...
                            <PaginationItem>
                              <PaginationNext
                                ...
                                onClick={(e) => {
                                  ...
                                  setSearchState({
                                    page: String(
                                      Math.min(projectsData.metadata.lastPage, projectsData.metadata.currentPage + 1)
                                    ),
                                  })
                                }}
                                aria-disabled={projectsData.metadata.currentPage === projectsData.metadata.lastPage}
                                className={
                                  projectsData.metadata.currentPage === projectsData.metadata.lastPage
